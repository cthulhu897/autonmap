...
ALIVEHOSTS="nmap -sn -PE -PP -PM -PS80,443,22,3389,1723,8080,3306,135,53,143,139,445,110,25,21,23,5432,27017,1521 -PU139,53,67,135,445,1434,138,123,137,161,631 $TARGET -oA $DIRECTORY/autonmap_Alive_$NAME";
echo "[+] ================================================================================";
...
cat "$DIRECTORY"/autonmap_Alive_"$NAME".gnmap | grep "Status: Up" | cut -d " " -f 2 > "$DIRECTORY"/il_alive_"$NAME".lst;
...
if [ -z "${TCPPORTS}" ]; then
    NMAPSCAN="nmap -sS -sV -sC -O -A -p T:22,80,443,U:137,161,"$UDPPORTS" $TARGET -oA "$DIRECTORY"/autonmap_ServiceScan_"$NAME"";
else
    NMAPSCAN="nmap -sS -sV -sC -O -A -p T:22,80,443,"$TCPPORTS",U:137,161,"$UDPPORTS" $TARGET -oA "$DIRECTORY"/autonmap_ServiceScan_"$NAME"";
fi
echo "[+] ================================================================================";
