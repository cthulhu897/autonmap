...
if [ -d "$DIRECTORY" ]; then
  echo -e "[!]\t ERROR!"
  echo -e "[!] $NAME is a directory that already exists in this system. Please provide another name!\n\n";
  exit 1;
fi

#init the varibles and mkdir
echo "[+] Creating directories for output as $(pwd)/$NAME/"
mkdir $NAME

#Host discovery on top ports
ALIVEHOSTS="nmap -sn -PE -PP -PM -PS80,443,22,3389,1723,8080,3306,135,53,143,139,445,110,25,21,23,5432,27017,1521 -PU139,53,67,135,445,1434,138,123,137,161,631 $TARGET -oA $NAME/nmap_host-discovery_$NAME";
echo "[+] ================================================================================";
